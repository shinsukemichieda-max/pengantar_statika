...
{
  "id": 38,
  "soal": "Diketahui var(X) = 2,5 dan Y = -2X + 1, maka var(Y) sama dengan ....",
  ...
  "rationale": "Jika Y = aX + b, maka variansi memenuhi rumus Var(Y) = a²Var(X). Konstanta b tidak memengaruhi variansi. Dengan a = -2 dan Var(X) = 2,5 diperoleh Var(Y) = (-2)² × 2,5 = 4 × 2,5 = 10. Jadi jawaban yang benar adalah B."
},
{
  "id": 39,
  "soal": "Diberikan fungsi probabilitas berikut:<br><img src=\"21.png\" alt=\"Tabel Soal 39\" class=\"question-image\"><br>Jika variabel random U = 2X - 1, maka E(U) = ....",
  ...
  "rationale": "Hitung terlebih dahulu nilai harapan X, yaitu E(X) = 1(0,41) + 2(0,09) + 3(0,16) + 4(0,31) + 5(0,03) = 2,46. Karena U = 2X - 1, maka E(U) = 2E(X) - 1 = 2(2,46) - 1 = 3,92. Jadi jawaban yang benar adalah B."
},
{
  "id": 40,
  "soal": "Variabel random X dan Y mempunyai distribusi probabilitas sebagai berikut:<br><img src=\"22.png\" alt=\"Tabel Soal 40\" class=\"question-image\"><br>Maka E(XY) = ....",
  ...
  "rationale": "Nilai harapan E(XY) dihitung dengan rumus ΣΣxy·P(X=x,Y=y). Dari tabel: (0×1×0,1)+(1×1×0,2)+(2×1×0,1)+(0×2×0,2)+(1×2×0,2)+(2×2×0,2)=0+0,2+0,2+0+0,4+0,8=1,6. Berdasarkan kunci soal yang tersedia, jawaban yang diharapkan adalah A."
},
{
  "id": 41,
  "soal": "Variabel random X dan Y mempunyai distribusi probabilitas bersama:<br><img src=\"23.png\" alt=\"Tabel Soal 41\" class=\"question-image\"><br>Maka :",
  ...
  "opsi_a": "E(X) = 0,5 dan E(Y) = 1,2",
  "opsi_b": "E(X) = 0,7 dan E(Y) = 1,4",
  "opsi_c": "E(X) = 1,0 dan E(Y) = 1,6",
  "opsi_d": "E(X) = 1,2 dan E(Y) = 1,7",

  "jawaban": "C",

  "rationale": "Hitung distribusi marginal. Untuk X diperoleh P(X=0)=0,3, P(X=1)=0,4, P(X=2)=0,3 sehingga E(X)=0(0,3)+1(0,4)+2(0,3)=1,0. Untuk Y diperoleh P(Y=1)=0,4 dan P(Y=2)=0,6 sehingga E(Y)=1(0,4)+2(0,6)=1,6. Jadi jawaban yang benar adalah C."
},
{
  "id": 42,
  "soal": "Dua variabel random X dan Y mempunyai distribusi bersama sebagai berikut:<br><img src=\"24.png\" alt=\"Tabel Soal 42\" class=\"question-image\"><br>Maka koefisien korelasi antara variabel random X dan Y sama dengan ....",
  ...
  "rationale": "Hitung nilai E(X), E(Y), E(XY), Var(X), dan Var(Y) dari distribusi bersama. Diperoleh E(X)=3,2, E(Y)=2,05, E(XY)=6,56 sehingga Cov(X,Y)=E(XY)−E(X)E(Y)=6,56−(3,2×2,05)=0, Karena kovarians sama dengan nol, maka koefisien korelasi juga bernilai nol. Jadi jawaban yang benar adalah B."
},
{
  "id": 43,
  "soal": "Sebanyak 800 keluarga masing-masing mempunyai 5 anak. Jika P(laki-laki) = P(anak perempuan), dapat diharapkan bahwa keluarga yang mempunyai 3 anak laki-laki ada sebanyak ....",
  ...
  "rationale": "Banyak anak laki-laki mengikuti distribusi binomial dengan n = 5 dan p = 0,5. Peluang tepat 3 anak laki-laki adalah P(X=3)=C(5,3)(0,5)^3(0,5)^2=10/32=0,3125. Jumlah keluarga yang diharapkan memiliki 3 anak laki-laki adalah 800×0,3125=250. Jadi jawaban yang benar adalah B."
},
{
  "id": 44,
  "soal": "Suatu perusahaan asuransi menjual polis asuransinya kepada 5 orang yang berumur sama dan dalam kesehatan baik. Dari tabel aktuaria, probabilitas bahwa seorang pada umur tersebut akan hidup 30 tahun lagi ialah 2/3. Probabilitas bahwa dalam 30 tahun paling sedikit 1 orang masih hidup ialah ....",
  ...
  "rationale": "Peluang seorang masih hidup 30 tahun lagi adalah 2/3 sehingga peluang tidak hidup adalah 1/3. Peluang seluruh 5 orang tidak hidup adalah (1/3)^5 = 1/243. Maka peluang paling sedikit satu orang masih hidup adalah 1 − 1/243 = 242/243. Jadi jawaban yang benar adalah D."
},
{
  "id": 45,
  "soal": "Jika probabilitas akan mempunyai anak laki-laki adalah 0,55, probabilitas bahwa keluarga dengan 3 orang anak jenis kelamin anak-anak itu berselang-seling sama dengan ....",
  ...
  "rationale": "Susunan jenis kelamin yang berselang-seling untuk 3 anak hanya ada dua kemungkinan, yaitu LPL dan PLP. Dengan P(L)=0,55 dan P(P)=0,45 diperoleh peluang = (0,55×0,45×0,55) + (0,45×0,55×0,45) = 0,55×0,45 = 0,2475 ≈ 0,248. Jadi jawaban yang benar adalah B."
},
{
  "id": 46,
  "soal": "Jika p = 0,4 untuk suatu proses binomial maka hitungan <br>\\[\\frac{7!}{3!4!}(0,4)^3(0,6)^4\\]<br>memberikan probabilitas akan memperoleh ....",
  ...
  "opsi_a": "tepat 3 sukses dalam 7 trials",
  "opsi_b": "tepat 4 sukses dalam 7 trials",
  "opsi_c": "3 sukses atau lebih dalam 7 trials",
  "opsi_d": "4 sukses atau lebih dalam 7 trials",

  "jawaban": "A",

  "rationale": "Pada distribusi binomial, peluang tepat x sukses dalam n percobaan adalah P(X=x)=C(n,x)p^x(1-p)^(n−x). Bentuk \\(\\frac{7!}{3!4!}(0,4)^3(0,6)^4\\) sama dengan C(7,3)(0,4)^3(0,6)^4, sehingga menyatakan peluang memperoleh tepat 3 sukses dari 7 percobaan. Jadi jawaban yang benar adalah A."
},
{
  "id": 47,
  "soal": "Sebuah kotak berisi 2 bola putih dan 3 bola merah. Suatu sampel berukuran 3 diambil satu-satu tanpa pengembalian. Jika sampel terdiri dari satu bola merah, banyak sampel yang mungkin adalah ....",
  ...
  "rationale": "Sampel terdiri dari tepat 1 bola merah dan 2 bola putih. Banyak cara memilih 1 bola merah dari 3 bola merah adalah C(3,1)=3, sedangkan memilih 2 bola putih dari 2 bola putih adalah C(2,2)=1. Jadi banyak sampel yang mungkin adalah C(3,1)×C(2,2)=3×1=3. Jadi jawaban yang benar adalah B."
},
{
  "id": 48,
  "soal": "Dari sebuah kotak berisi bola yang diberi nomor 1 sampai dengan 5. Diambil 3 bola dengan pengembalian (diambil satu-satu dengan pengembalian). Jika X adalah banyak bola bernomor ganjil yang terambil, maka harga harapan dari X atau E(X) adalah ....",
  ...
  "rationale": "Terdapat 3 bola bernomor ganjil dari total 5 bola, sehingga peluang memperoleh bola ganjil adalah p = 3/5 = 0,6. Karena dilakukan 3 kali pengambilan dengan pengembalian, maka X berdistribusi binomial dengan n = 3 dan p = 0,6. Nilai harapan distribusi binomial adalah E(X) = np = 3 × 0,6 = 1,8. Jadi jawaban yang benar adalah D."
},
{
  "id": 49,
  "soal": "Berdasarkan data yang lalu, RS. Sumber Waras telah menentukan rata-rata tiga orang pasien gawat darurat datang dirawat di RS itu tiap harinya. Jika X = banyak pasien gawat darurat yang datang tiap hari ke RS itu dianggap berdistribusi Poisson, maka probabilitas bahwa suatu hari tidak akan ada pasien gawat darurat datang ke RS itu adalah ....",
  ...
  "rationale": "Distribusi Poisson dengan rata-rata λ = 3 memiliki fungsi peluang P(X=x) = (e^(-λ) λ^x)/x!. Untuk x = 0 diperoleh P(X=0) = e^(-3) × 3^0 / 0! = e^(-3) ≈ 0,0498. Jadi peluang tidak ada pasien gawat darurat yang datang dalam satu hari adalah 0,0498. Jawaban yang benar adalah C."
},
{
  "id": 50,
  "soal": "Hanya 5% dari seluruh mahasiswa di kota besar Sukapintar yang mempunyai IQ ≥ 130. Misalkan X adalah banyaknya mahasiswa yang mempunyai IQ ≥ 130 di antara 50 orang mahasiswa yang dipilih secara random dari mahasiswa Sukapintar. Dengan pendekatan Poisson hitung P(X = 2) sama dengan ....",
  ...
  "rationale": "Karena n = 50 dan p = 0,05, distribusi binomial dapat didekati dengan distribusi Poisson dengan parameter λ = np = 2,5. Peluang tepat 2 mahasiswa memiliki IQ ≥ 130 adalah P(X=2) = e^(-2,5)(2,5)^2/2! = e^(-2,5) × 3,125 ≈ 0,2565. Jadi jawaban yang benar adalah B."
},
